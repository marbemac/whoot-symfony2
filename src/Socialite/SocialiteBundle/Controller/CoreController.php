...
//            return $response;
        ...
        return $this->container->get('templating')->renderResponse('SocialiteBundle:Core:feed_filters.html.twig', array(
    ...
    /*
     * Socialite stores the user feed settings in their session. This toggles a postType from showing in feeds.
     *
    ...
    /*
     * Socialite stores the user feed settings in their session. This changes a setting.
     *
