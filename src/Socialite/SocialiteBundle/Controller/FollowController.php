...
class FollowController extends ContainerAware
{
    ...
    public function toggleAction($userId)
    {
        ...
        $userManager = $this->container->get('socialite.user_manager');
    ...
    public function tagAction($toUser)
    {
        ...
        if ($securityContext->isGranted('ROLE_USER'))
        {
            ...
            $connection = $this->container->get('socialite.user_manager')->findFollowConnection($fromUser, $toUser);
        }
        else
        {
            $fromUser = null;
        ...
        return $this->container->get('templating')->renderResponse('SocialiteBundle:Follow:tag.html.twig', array(
            'fromUser' => $fromUser,
            'toUser' => $toUser,
