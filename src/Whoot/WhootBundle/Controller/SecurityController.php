...
class SecurityController extends ContainerAware
{
    ...
    public function loginAction($chromeless=false)
    {
        ...
        {
            return $this->container->get('templating')->renderResponse('WhootBundle:Security:login_content.html.twig', array(
        ...
        return $this->container->get('templating')->renderResponse('WhootBundle:Security:login.html.twig', array(
            // last username entered by the user
            'last_username' => $this->container->get('request')->getSession()->get(SecurityContext::LAST_USERNAME),
            'error'         => $error
        ));
